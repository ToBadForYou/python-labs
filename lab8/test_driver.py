...
def new_cases():
    ...
    new_test_case(
        2,
        "06:00",                        # Search interval starts
        "09:00",                        # Search interval ends
        [], # This day's appointments
        ["06:00-09:00"]) # Expected free time

    new_test_case(
        3,
        "18:00",                        # Search interval starts
        "22:00",                        # Search interval ends
        ["07:00-09:00", "13:00-18:00"], # This day's appointments
        ["18:00-22:00"]) # Expected free time

    new_test_case(
        4,
        "10:00",                        # Search interval starts
        "12:00",                        # Search interval ends
        ["11:00-12:00"], # This day's appointments
        ["10:00-11:00"]) # Expected free time

    new_test_case(
        5,
        "08:00",                        # Search interval starts
        "22:00",                        # Search interval ends
        ["11:00-12:00","12:00-14:00", "15:00-18:00"], # This day's appointments
        ["08:00-11:00", "14:00-15:00", "18:00-22:00"]) # Expected free time
